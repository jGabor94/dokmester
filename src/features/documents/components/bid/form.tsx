...
import { countryCodes, currencyCodes } from "@/lib/constants";
import { PlusIcon, XIcon } from "lucide-react";
import { FC, useEffect } from "react";
import { Controller, useFieldArray, UseFormReturn } from "react-hook-form";
import { BidInputs } from "../../lib/types/document";

const NewBidForm: FC<{ company: FullCompany, form: UseFormReturn<BidInputs>, partners: SelectPartner[] }> = ({ company, form, partners }) => {
        ...
        <div className={`flex flex-row flex-wrap w-full gap-4`}>
          ...
          <div className={`border shadow-sm p-3 rounded-2xl bg-card w-full flex-1 gap-4 h-max min-w-[500px] flex flex-col `}>
            ...
            <div>
              ...
              <Input type={`text`} placeholder={`Név`} id="customer.name" {...form.register("customer.name")} />
            </div>
            <div>
